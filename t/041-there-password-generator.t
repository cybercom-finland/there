...
foreach my $round (1..2)
{
  ...
  is(length($pass), length("my penis"), "generated password was of perfect length");
  ...
  is(length($betterpass), length("twice that penis"), "generated password was of perfect length");
